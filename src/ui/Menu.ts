...
export class Menu {
  ...
  private _build(): void {
    ...
    this.root.innerHTML = `
      ...
      <!-- SETTINGS SCREEN -->
      <div id="screen-settings" style="display:none;text-align:center;">
      ...
      <!-- CREDITS SCREEN -->
      <div id="screen-credits" style="display:none;text-align:center;">
